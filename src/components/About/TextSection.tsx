  ...
  return (
    <div className="container mx-auto px-6">
      <p className="text-2xl mb-6">
        Hi, I'm Danny Sickels—a full-stack developer who brings a scientific
        rigor to every line of code. My career began in Nutrition & Dietetics,
        where I learned to study complex systems, collect clean data, and test
        hypotheses. As a Quality Assurance Technician at a large-scale food
        manufacturer, I've honed an eye for detail, documented every variable,
      ...
      <ul className="text-2xl space-y-4 mb-6">
        <li className="flex items-start gap-3">
          ...
          <div className="text-left">
            ...
            crafted modern web apps with frameworks like React, and FastAPI,
            supported by SQL and real-time databases.
          </div>
        </li>
        <li className="flex items-start gap-3">
          <Anchor
      ...
      <p className="text-2xl mt-8 mb-6 pb-20">
        If you're looking for a developer who pairs scientific curiosity with
        production-ready code, let's connect. Check out my projects or send me a
        message!
      </p>
    </div>
  );
